...
public class KVServer {
    ...
    public static void main(String[] args) throws IOException {
        ...
        kvServer.start();
        System.out.println(PORT_KV_SERVER);
    }
    ...
    private void save(HttpExchange h) throws IOException {
        try {
            ...
            if ("POST".equals(h.getRequestMethod())) {
                ...
                data.put(key, value);
                System.out.print("Значение для ключа " + key + " успешно обновлено!");
    ...
    public void start() {
        ...
        System.out.println("Открой в браузере http://localhost:" + PORT_KV_SERVER + "/");
